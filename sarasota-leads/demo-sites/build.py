...
THEMES = {
    ...
    "blush":   dict(h1="#9f1239", h2="#db2777", glow="#fbcfe8", bg="#fdf4f8", ink="#3d1226", card="#ffffff", ac="#be185d", ac2="#fbcfe8", font="elegant"),
...
BUSINESSES = [
    ...
    B(name="Jamaican American Soul Food", theme="fiesta", word="JERK", cat="Jamaican & Soul Food",
      ...
      stats=[("2","Cuisines, one kitchen"),("2","Delivery apps"),("MLK","Jr. Way, Sarasota")],
    ...
    B(name="Rose and Dagger Tattoo Studio", theme="ink", word="SIESTA KEY", cat="Tattoo Studio",
      ...
      stats=[("#1","Beach in America, next door"),("1","Only studio on the Key"),("7","Days of walk-ins")],
    ...
    B(name="Croz's Surfshack", theme="fiesta", word="ALOHA", cat="Gourmet Hot Dogs & Hawaiian",
      ...
      stats=[("2014","Rolling since"),("2","Counties covered"),("100%","Island vibes")],
    ...
    B(name="Pink Petals Nail Spa", theme="blush", word="PETALS", cat="Nail Salon",
      tagline="Where University Parkway gets its nails done.",
      ...
      badges=["University Pkwy","Book on Fresha","Walk-ins & groups"],
      stats=[("4.9★","Average rating"),("687","Reviews"),("Fresha","Online booking")],
